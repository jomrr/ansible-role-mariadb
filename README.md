...
[![dev](https://img.shields.io/github/actions/workflow/status/jomrr/ansible-role-mariadb/dev.yml?branch=dev&label=dev)](https://github.com/jomrr/ansible-role-mariadb/actions/workflows/dev.yml?query=branch%3Adev)
[![main](https://img.shields.io/github/actions/workflow/status/jomrr/ansible-role-mariadb/main.yml?branch=main&label=main)](https://github.com/jomrr/ansible-role-mariadb/actions/workflows/main.yml?query=branch%3Amain)
